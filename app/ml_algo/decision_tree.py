...
class DecisionTree():
    ...
    def fit(self, X, y):
        ...
        # The build_tree method should recursively split the data and create nodes/tree structure

    def predict(self, X):
        if not self.root:
            raise Exception("The decision tree model has not been fitted yet.")
